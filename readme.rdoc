...
2. After the solution has been built(Ctrl+SHIFT+B), navigate to where you cloned the project/repo and navigate to DotNetKoans-master/AutoKoanRunner/bin/Debug/AutoKoanRunner.exe
3. Each time you perform/modify a koan, make sure to Save(Ctrl+S) the changes in order for the console to update.
...
https://github.com/matthew17754/DotNetKoans/blob/master/CSharp-Koans.png
